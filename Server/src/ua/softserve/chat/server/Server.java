...
public class Server {
    ...
    public static synchronized Server getInstance(Security security) {
        if (instance == null) {
            instance = new Server(security);
        }
        return instance;
    }
    ...
    private Server(Security security) {
...
//    }
    public static void main(String[] args) {
        Server server = Server.getInstance(Security.UNSECURE);
        server.start();
    }
